...
use obs_dock::{
    get_queue_handler, get_queue_state_handler, get_run_counter_handler, next_queue_handler,
    remove_from_queue_handler, toggle_queue_handler, update_queue_order,
};
...
async fn main() -> Result<(), BotError> {
    ...
    let queue_drag_drop = warp::path("queue")
